...
example :
    ...
    = natToByteArray 0xb0344c61d8db38535ca8afceaf0bf12b881dc200c9833da726e9376c2e32cff7 := by
  native_decide

-- Test vector 2:
example :
    sha256hmac "what do ya want for nothing?".toUTF8 "Jefe".toUTF8
    = natToByteArray 0x5bdcc146bf60754e6a042426089575c75a003f089d2739839dec58b964ec3843 := by
  native_decide
...
example :
    ...
    = natToByteArray 0x773ea91e36800e46854db8ebd09181a72959098b3ef8c122d9635514ced565fe := by
  native_decide
...
example :
    ...
    = natToByteArray 0x82558a389a443c0ea4cc819899f2083a85f0faa3e578f8077a2e3ff46729665b := by
  native_decide
...
example :
    ...
    = natToByteArray 0xa3b6167473100ee06e0c796c2955552b := by
  native_decide
...
example :
    ...
    = natToByteArray 0x60e431591ee0b67f0d8a26aacbf5b77f8e0bc6213728c5140546040f0ee37f54 := by
  native_decide
...
example :
    sha256hmac
      ...
      (ByteArray.mk (Array.replicate 131 0xaa))
    = natToByteArray 0x9b09ffa71b942fcb27635fbcd5b0e944bfdc63644f0713938a7f51535c3a35e2 := by
  native_decide
